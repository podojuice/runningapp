...
import kotlinx.android.synthetic.main.activity_club_challenge_thismonth50k.view.*
import kotlinx.android.synthetic.main.activity_login.*
import kotlinx.android.synthetic.main.fragment_club_event.*
                ...
                override fun onResponse(call: Call<Boolean>, response: Response<Boolean>) {
                    if(response.code()==200){
                        if(response.body()!!){
                            ...
                            val intent = Intent(this@ClubChallengeMonthly50Activity, ClubActivity::class.java)
