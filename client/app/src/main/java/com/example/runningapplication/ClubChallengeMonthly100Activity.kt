...
class ClubChallengeMonthly100Activity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_club_challenge_monthly100)
                ...
                override fun onResponse(call: Call<Boolean>, response: Response<Boolean>) {
                    if(response.code()==200){
                        if(response.body()!!){
                            ...
                            val intent = Intent(this@ClubChallengeMonthly100Activity, ClubActivity::class.java)
